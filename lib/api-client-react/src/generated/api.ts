...
export const generateCoverLetter = async (
  ...
  return customFetch<CoverLetterResponse>(getGenerateCoverLetterUrl(id), {
    ...options,
    method: "POST",
  });
};
...
export const getRecentAnalyses = async (
  ...
  return customFetch<RecentAnalysesResponse>(getGetRecentAnalysesUrl(), {
    ...options,
    method: "GET",
  });
};
...
export type GetRecentAnalysesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getRecentAnalyses>>
>;
export type GetRecentAnalysesQueryError = ErrorType<ErrorResponse>;
